...
cat ("Conclusion: here we can found that log of bathrooms give better performance than bathrooms with one expection in when bathroom=7.")
#*******Removing the outliers
...
cat ("Conclusion: Strong correlation, as Lining sqft increases, price increases as well.")
#*******Removing the outliers
...
cat ("Conclusion: Moderate correlation, view increases, price increases as well")
#*******Removing the outliers
analysis(houseData,10,c('View vs. price','View', 'Price of House'), 'Y', 'Y')
#bucketByColumn(houseData,10)
```
...
cat ("Conclusion: Moderate correlation, grade increases, price increases as well")
#*******Removing the outliers
...
cat ("Conclusion: This is more like a normal dist relationship, but this can be modeled easily. So we should include LAT for price predication")
#*******Removing the outliers
...
## Since above scatterplot is too crowded, 
## I will plot aggregated vectors to verify the relationship between 2 variables. 
...
cat ("\nConclusion: Plot 2 clustered the data points in mid range of both axis and plot 1's data points are clustered around lower range of both axis")
...
##STEP -01 : One variable predication - START
...
```
##STEP -01 : one variable predication - END

##STEP -02 :  Add more attributes to model - START
...
```
##STEP -02 :  Add more attributes to model - END


##STEP -03 :  Sometime we should, Use Residual to add more eligible attributes for model - START
...
```
##STEP -03 :  Use Residual to more eligible attributes for model - END


##STEP -04 :  Add Attributes found using Residual - START
...
```
##STEP -04 :  Add Attributes found using Residual - END


##STEP -05 :  Come Up with the Model, using bit of common sense - START
...
##STEP -05 :  Come Up with the Model, using bit of common sense - END

## Selection Method: End

##STEP -06 :  Get correct Intercept & coefficient for derived Model - START
